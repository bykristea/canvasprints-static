  ...
  categories: [
    {
      ...
      collection: [
        ...
        { name: 'Triptych Canvas Prints', href: '#' },
        { name: 'Wall Displays', href: '#' },
        { name: 'Collages', href: '#' },
      ],
    ...
    },
    {
      ...
      collection: [
        { name: 'Photo Pillows', href: '#' },
        { name: 'Metal Prints', href: '#' },
        { name: 'Woven Blanket', href: '#' },
        { name: 'Fleece Blanket', href: '#' },
      ],
                  ...
                  <Tab.List className="-mb-px flex px-4 space-x-8">
                    {navigation.categories.map((category) => (
                      <Tab
                        ...
                        className={({ selected }) =>
                          classNames(
                            selected ? 'text-pink border-pink' : 'text-gray-900 border-transparent',
          ...
          <div className="bg-gray-900">
            <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
              ...
              <p className="flex-1 text-center text-sm font-medium text-white lg:flex-none">
                FREE Shipping on ALL orders until FEB 14!
              </p>
              ...
              <div className="border-b border-gray-200">
                <div className="h-16 flex items-center justify-between">
                  ...
                  <div className="hidden lg:flex lg:items-center">
                    <a href="#">
                      <span className="sr-only">CanvasPrints.com</span>
                      <img
                        className="h-8 w-auto"
                        src="https://cdn.shopify.com/s/files/1/0257/4522/7828/files/CanvasPrints_LogoV2_51b90d0d-6ed4-4e65-aafe-fa19f0cb4f12_900x.png?v=1636559713"
                        alt=""
                      />
                    </a>
                  </div>
